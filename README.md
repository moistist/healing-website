...
> 每日一句疗愈语 + 快速操作按钮 + 功能入口卡片

![首页](screenshots/01-home.png)

### AI 对话

> 气泡式消息界面，支持流式逐字输出，Enter 发送 / Shift+Enter 换行

![AI 对话](screenshots/02-chat.png)

### 情绪记录

> 10 种预设情绪 + 自定义输入 + 最近 7 天趋势堆叠柱状图

![情绪记录](screenshots/03-emotions.png)

### 冥想练习

> 呼吸动画（吸-屏-呼循环）+ 3 套冥想引导文字 + 可选 5/10/15/20 分钟

![冥想练习](screenshots/04-meditation.png)

### 心情日记

> 标题/内容/心情标签，按今天/昨天/本周/更早分组，支持日期筛选和 CRUD

![心情日记](screenshots/05-journal.png)
